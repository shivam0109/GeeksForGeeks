...
/*
Consider the three ranges X = (0,2/3), Y = [2/3,1], Z = (1,2). At most one value can come from Z (if two values came from Z, then the sum would exceed 1+1=2). 
Similarly, at least one value must come from X. 
Suppose there were 3 values a <= b <= c so that 1 <= a+b+c <= 2 . 
Then, consider what possible classes of solutions are feasible:
...
public class TripletSum {
    ...
    public static void main(String[] args) {
        double[] list = {
            0.1, 2.3, 0.01, 1.25, 0.02, 0.4, 1.99
        };
        ...
        if (triplet == null) {
            ...
            System.out.print("The following triplet exists: <");
